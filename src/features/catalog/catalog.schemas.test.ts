...
describe('current listing tracker contract', () => {
  it('accepts listings from different sources and modules', () => {
    const listing = {
      ...
      productId: 'product-1', productTitle: 'Example item', manufacturer: 'Example Maker', category: 'Components', tags: ['example'], variantId: 'variant-1', variantTitle: 'Blue', sku: 'SKU-1', imageUrl: null, title: 'Example item — Blue',
      price: '12.50', compareAtPrice: '19.00', currency: 'USD', available: true, observedAt: new Date(),
    }
