...
describe('current listing tracker contract', () => {
  it('accepts listings from different sources and modules', () => {
    const listing = {
      ...
      productId: 'product-1', productTitle: 'Example item', manufacturer: 'Example Maker', category: 'Components', variantId: 'variant-1', variantTitle: 'Blue', sku: 'SKU-1', imageUrl: null, title: 'Example item — Blue',
